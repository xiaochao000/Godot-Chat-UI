...
@onready var _emoji_btn = %EmojiPickerBtn
@onready var _attach_btn = %AttachBtn
...
func _ready() -> void:
	...
	_emoji_btn.pressed.connect(func(): print("Emoji picker pressed"))
	_attach_btn.pressed.connect(func(): print("Attach file pressed"))
	_audio_btn.pressed.connect(func(): print("Audio record pressed"))
